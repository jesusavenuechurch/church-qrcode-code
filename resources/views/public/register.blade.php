    ...
    <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white rounded-lg shadow-md p-8">
            ...
            <form method="POST" action="{{ route('registration.submit', ['orgSlug' => $organization->slug, 'eventSlug' => $event->slug]) }}">
                ...
                <div class="mb-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600 mt-1">Your ticket will be sent to this email</p>
                        </div>
                                        ...
                                        <div>
                                            ...
                                            <div class="flex">
                                                ...
                                                <input type="tel"
                                                    ...
                                                    class="flex-1 px-4 py-2 border border-gray-300 rounded-r-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                                                    placeholder="5949 4756"
                                                    pattern="[0-9]{4} [0-9]{4}"
                                                    maxlength="9">
                                            </div>
                        ...
                        document.addEventListener('DOMContentLoaded', function() {
                            const companionPhones = document.querySelectorAll('input[name^="companion_"][name$="_phone"]');

                            companionPhones.forEach(input => {
                        ...
                        // On form submit, clean and prepend +266
                        document.querySelector('form').addEventListener('submit', function(e) {
                            const phoneInput = document.getElementById('phone_input');
                            let cleanPhone = phoneInput.value.replace(/\D/g, ''); // Remove spaces
                ...
                <!-- Replace the entire "Select Payment Method" section in register.blade.php (after Personal Information) -->
                @if($selectedTier && $selectedTier->price > 0)
                <div class="mb-8">
                    ...
                    @if($paymentMethods->isNotEmpty())
                        ...
                        <!-- Custom Deposit Amount (shows when installment selected) -->
